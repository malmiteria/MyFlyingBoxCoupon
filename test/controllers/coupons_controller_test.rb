...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { amount: @coupon.amount, start: @coupon.start, stop: @coupon.stop } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { amount: @coupon.amount, start: @coupon.start, stop: @coupon.stop } }
